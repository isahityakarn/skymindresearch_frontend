...
export default function DashboardOverview() {
    ...
    return (<div className="dashboard-overview"> {/* Main Stats Cards */}
            ...
            <div className="col-md-3 col-sm-6">
                <div className="card bg-success text-white h-100">
                    <div className="card-body">
                        ...
                        <h2 className="card-title mb-0"> {
                            stats.surveys ?. toLocaleString() || 0
                        }</h2>
                    </div>
                </div>
            </div>
                ...
                <div className="card border-success h-100">
                    <div className="card-body">
                        ...
                        <h3 className="mb-0 text-success"> {
                            stats.totalComplete ?. toLocaleString() || 0
                        }</h3>
                    </div>
                </div>
            </div>
                ...
                <div className="card border-warning h-100">
                    <div className="card-body">
                        ...
                        <h3 className="mb-0 text-warning"> {
                            stats.totalQuotafull ?. toLocaleString() || 0
                        }</h3>
                    </div>
                </div>
            </div>
                ...
                <div className="card border-danger h-100">
                    <div className="card-body">
                        ...
                        <h3 className="mb-0 text-danger"> {
                            stats.totalTerminate ?. toLocaleString() || 0
                        }</h3>
                    </div>
                </div>
            </div>
                            ...
                            <div className="col-3">
                                <div className="mb-2">
                                    ...
                                    <h4 className="mb-0 text-success"> {
                                        stats.monthComplete ?. toLocaleString() || 0
                                    }</h4>
                                </div>
                            </div>
                            <div className="col-3">
                                <div className="mb-2">
                                    ...
                                    <h4 className="mb-0 text-warning"> {
                                        stats.monthQuotafull ?. toLocaleString() || 0
                                    }</h4>
                                </div>
                            </div>
                            <div className="col-3">
                                <div className="mb-2">
                                    ...
                                    <h4 className="mb-0 text-danger"> {
                                        stats.monthTerminate ?. toLocaleString() || 0
                                    }</h4>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="row text-center">
                            ...
                            <div className="col-3">
                                <div className="mb-2">
                                    <small className="text-success d-block">Complete</small>
                                    <h4 className="mb-0 text-success"> {
                                        stats.todayComplete ?. toLocaleString() || 0
                                    }</h4>
                                </div>
                            </div>
                            <div className="col-3">
                                <div className="mb-2">
                                    <small className="text-warning d-block">Quota Full</small>
                                    <h4 className="mb-0 text-warning"> {
                                        stats.todayQuotafull ?. toLocaleString() || 0
                                    }</h4>
                                </div>
                            </div>
                            <div className="col-3">
                                <div className="mb-2">
                                    <small className="text-danger d-block">Terminate</small>
                                    <h4 className="mb-0 text-danger"> {
                                        stats.todayTerminate ?. toLocaleString() || 0
                                    }</h4>
                                </div>
                            </div>
                        </div>
        ...
        <div className="row g-4 mb-4">
            <div className="col-md-6">
                <div className="card h-100">
                    ...
                    <div className="card-body"> {
                        surveyStatusBreakdown.length > 0 ? (<div className="table-responsive">
                                ...
                                <tbody> {
                                    surveyStatusBreakdown.map((item, index) => {
                                        ...
                                        return (<tr key={index}>
                                            <td>
                                                <span className={
                                                    `badge bg-${badgeColor} text-capitalize`
                                                }> {
                                                    item.status
                                                } </span>
                                            </td>
                        ...
                        </div>) : (<p className="text-muted mb-0">No survey status data available</p>)
                    } </div>
                </div>
            </div>
            ...
            <div className="col-md-6">
                <div className="card h-100">
                    ...
                    <div className="card-body"> {
                        vendorSurveyStatusBreakdown.length > 0 ? (<div className="table-responsive">
                            <table className="table table-hover">
                                <thead>
                                    <tr>
                                        <th>Status</th>
                        ...
                        </div>) : (<p className="text-muted mb-0">No vendor survey status data available</p>)
                    } </div>
                </div>
            </div>
        </div>
        ...
        <div className="row g-4 mb-4">
            <div className="col-12">
                <div className="card">
                    ...
                    <div className="card-body"> {
                        recentSurveys.length > 0 ? (<div className="table-responsive">
                        ...
                        </div>) : (<p className="text-muted mb-0">No recent surveys available</p>)
                    } </div>
                </div>
            </div>
        </div>
            ...
            <div className="col-12">
                <div className="card">
                    <div className="card-header bg-dark text-white d-flex justify-content-between align-items-center">
                        ...
                        <span className="badge bg-secondary"> {
                            recentVendorSurveys.length
                        }
                            surveys</span>
                    </div>
                    <div className="card-body"> {
                        recentVendorSurveys.length > 0 ? (<div className="table-responsive">
                            <table className="table table-hover table-sm">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                    ...
                                    recentVendorSurveys.map((survey) => {
                                        ...
                                        return (<tr key={
                                            ...
                                            <td className="text-primary"> {
                                                survey.vendor_name || 'N/A'
                                            }</td>
                                            <td>
                                                <code className="small"> {
                                                    survey.project_id || 'N/A'
                                                }</code>
                                            </td>
                                            <td>
                                                <code className="small"> {
                        ...
                        </div>) : (<p className="text-muted mb-0">No recent vendor surveys available</p>)
                    } </div>
                </div>
            </div>
        </div>
